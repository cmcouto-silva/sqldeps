...
def main() -> None:  # noqa: C901
    ...
    db_config = {}
    if enable_db:
        db_config["host"] = st.sidebar.text_input("Host", value="52.14.34.84")
            ...
            with st.spinner("Extracting dependencies..."):
                ...
                with col2:
                    ...
                    if dependencies.tables:
                        table_df = pd.DataFrame({"Table Name": dependencies.tables})
                        st.dataframe(
                    ...
                    if dependencies.columns:
                        for table_name, columns in dependencies.columns.items():
                    ...
                    if db_schema_match is not None:
                        ...
                        validation_tabs = st.tabs(
                            ["All Results", "Matches Only", "Missing Only"]
                        )
                        ...
                        with validation_tabs[1]:
                            matches = db_schema_match[
                                db_schema_match["exact_match"] is True
                            ]
                        ...
                        with validation_tabs[2]:
                            missing = db_schema_match[
                                db_schema_match["exact_match"] is False
                            ]
                    ...
                    if dependencies.to_dict()["tables"]:
                        st.markdown("#### As DataFrame")
